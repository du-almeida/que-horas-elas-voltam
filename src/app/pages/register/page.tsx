          ...
          <Form noValidate className="bg-white flex flex-col gap-2 p-4 border border-zinc-100 min-w-[300px] rounded">
            ...
            <span className="text-xs text-zinc-500">
              ...
              <strong className="text-xs text-violet-600 ml-2">
                <Link rel="stylesheet" href="/pages/login">Login</Link>
              </strong>
            </span>
          </Form>
        )} 
...
// import { EyeSlashFilledIcon } from "../../components/buttons/EyeSlashFilledIcon";
// import { EyeFilledIcon } from "../../components/buttons/EyeFilledIcon";
// import { useRouter } from "next/navigation";
// import * as Yup from "yup";
